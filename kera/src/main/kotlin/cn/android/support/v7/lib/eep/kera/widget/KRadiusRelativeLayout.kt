 ...
 */
open class KRadiusRelativeLayout : RelativeLayout {
    ...
    //自定义，重新绘图
    open fun draw(draw: ((canvas: Canvas, paint: Paint) -> Unit)? = null): KRadiusRelativeLayout {
        this.draw = draw
        postInvalidate()//刷新
        return this
    }
    ...
    fun onDraw_(onDraw: ((canvas: Canvas, paint: Paint) -> Unit)? = null): KRadiusRelativeLayout {
        this.onDraw = onDraw
        postInvalidate()//刷新
        return this
    }
