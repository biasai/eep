...
public class KProportion {
    ...
    public void init(float widthPixels, float heightPixels) {//必须是float类型
        //真实值
        DisplayMetrics displayMetrics = KApplication.getInstance().getResources().getDisplayMetrics();
...
//        Log.e("ui","ignore:\t"+ignore);
    ...
    public float getDimension(int id) {
        return KApplication.getInstance().getResources().getDimension(id);
    }
