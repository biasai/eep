...
class KDotsLvView : KView {
    ...
    fun defaultColor(defaultColor: Int = this.defaultColor): KDotsLvView {
    ...
    fun selectColor(selectColor: Int = this.selectColor): KDotsLvView {
        this.selectColor = selectColor
        return this
    }

    var radius = KProportionUtils.getInstance().adapterInt(15 / 2)//圆点半径
    fun radius(radius: Int = this.radius): KDotsLvView {
        this.radius = radius
        return this
    }

    var offset = KProportionUtils.getInstance().adapterInt(30)//圆点之间的间隙
    fun offset(offset: Int = this.offset): KDotsLvView {
        this.offset = offset
        return this
    }
    ...
    fun viewPager(viewPager: ViewPager?): KDotsLvView {
    ...
    fun selectPosition(selectPosition: Int = this.selectPosition): KDotsLvView {
