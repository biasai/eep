...
public class KSlideLayout extends FrameLayout {
    // 页面边缘阴影的宽度默认值
    ...
    public KSlideLayout(Context context, int mLeftShadowRes) {
        this(context, null);
    ...
    public KSlideLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public KSlideLayout(Context context, AttributeSet attrs, int defStyleAttr) {
